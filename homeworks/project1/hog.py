...
def boar_brawl(player_score, opponent_score):
    ...
    if opponent_score < 10:
        if player_score % 10 == 0:
            ...
            return 3 * (player_score % 10)
    res = abs((player_score % 10) - ((opponent_score // 10) % 10))
    return 1 if res == 0 else res * 3
    # END PROBLEM 2
...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score0 = update(s0, score0, score1, dice)
        elif who == 1:
            s1 = strategy1(score1, score0)
            score1 = update(s1, score1, score0, dice)
        who = 1 - who
    # END PROBLEM 5
...
def is_always_roll(strategy, goal=GOAL):
    ...
    for i in range(goal-1):
        for j in range(goal-1):
            if strategy(i, j) != strategy(j+1, i+1):
                return False
    return True
    # END PROBLEM 7
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    tmp = sus_update(0, score, opponent_score)
    return 0 if (tmp - score >= threshold) else num_rolls
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    item = abs((score % 10) - ((opponent_score / 10) % 10))
    if opponent_score > 10:
        if item == 2:
    ...
    if score >= 90:
        ...
        return always_roll(8)(score, opponent_score)
    elif abs(opponent_score - score) < 10:
        return catch_up(score, opponent_score)
    else:
        return always_roll(6)(score, opponent_score)
    # END PROBLEM 12
